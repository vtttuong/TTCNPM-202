...
,{
    "name":"Cocacola",
    "images":["https://product.hstatic.net/1000335596/product/img_0163_8dd37ca37c8b447080b3591e540dd99c_2a902d303dac43c0aef9d212828c0b8d.jpg?v1"],
    "category":10,
    "price":12000,
...
,{
    "name":"Fried noodles",
    "images":["https://yummyday.vn/uploads/images/cach-lam-mi-xao-long-ga.jpg?v1"],
    "category":3,
    "price":60000,
...
,{
    ...
    "images":["http://cdn.tgdd.vn/Files/2020/07/23/1273085/cach-lam-bach-tuot-hap-gung-thom-ngon-nuc-mui-202007231551145621.jpg?v1"],
    "category":7,
    "price":100000,
    "description":"abc",
    "quantity": 99,
...
,{
    "name":"Thai hot pot",
    "images":["https://i.ytimg.com/vi/p1ejp7z4mc4/hqdefault.jpg?v1"],
    "category":4,
    "price":120000,
    "description":"abc",
    "quantity": 99,
...
,{
    "name":"Tiger Beer",
    "images":["http://product.hstatic.net/1000373334/product/2._tiger__b3d67312661a4870ba760e02daf5aac1_grande.jpg?v1"],
    "category":10,
    "price":18000,
    "description":"abc",
    "quantity": 99,
...
,{
    "name":"Grill Steak",
    "images":["https://thestayathomechef.com/wp-content/uploads/2019/07/GrillingSteak2-500x375.jpg?v1"],
    "category":4,
    "price":60000,
    "description":"abc",
    "quantity": 99,
...
,{
    ...
    "images":["https://yummyday.vn/uploads/images/cach-nau-lau-ga-nam.jpg?v1"],
    "category":9,
    "price":150000,
    "description":"abc",
    "quantity": 99,
...
,{
    ...
    "images":["https://cdn.huongnghiepaau.com/wp-content/uploads/2018/01/727bc3e4d608fe10fff973bb7a50b7fe.jpg?v1"],
    "category":7,
    "price":100000,
    "description":"abc",
    "quantity": 99,
...
,{
    ...
    "images":["https://cdn.tgdd.vn/2020/08/CookProductThumb/Untitled-1-620x620-77.jpg?v1"],
    "category":8,
    "price":45000,
    "description":"abc",
    "quantity": 99,
...
for i in range(len(z)):
    z[i]=list(set(z[i]))
MB= list(apriori(z, min_support= 0.1, min_confidence= 0.2))
...
for item in listRules:
    ...
    data3={
    "name": str(i),
    "images": "https://bepkom9.com/wp-content/uploads/2019/09/com-bo-do-an-99k.jpg",
    "category": 13,
    "price": total,
    "description": "abc",
    "id": 0
